...
def run_commands(input_R1, input_R2, db_path, quality_option=False):
    try:
...
if __name__ == "__main__":
    ...
    # Run the commands with the provided input files and db path
    run_commands(args.reads[0], args.reads[1], args.db)
